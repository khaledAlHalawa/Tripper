...
// extension PageStateEXt<T> on PaginationState{
//   PaginationState<T> asPaginationState(PaginationState? state, int page) {
//     return PaginationState(
//       items: [
//         if (page > 0 && state != null) ...?state.items,
//         ...?result,
//       ],
//       nextPage: nextPage != null ? nextPage! - 1 : nextPage,
//     );
//   }
// }